    ...
    >
      <div className="flex justify-between items-center px-3.5 sm:px-8 py-3 sm:py-4 max-w-7xl mx-auto gap-2">
        ...
        >
          {sectionNavHidden ? (
            <>
              <JoinPartnerLink className="md:hidden inline-flex items-center justify-center shrink-0 min-h-10 px-3.5 py-2 rounded-xl bg-primary-container text-on-primary-container text-sm font-bold leading-snug shadow-md hover:brightness-110 transition-all active:scale-[0.98] focus:outline-none focus-visible:ring-2 focus-visible:ring-primary-container/60 focus-visible:ring-offset-2 focus-visible:ring-offset-[#131313] whitespace-nowrap">
                انضم الآن
              </JoinPartnerLink>
              <NavSocialLinks className="flex shrink-0 items-center gap-0 md:gap-1" />
              <JoinPartnerLink className="hidden sm:inline-flex items-center justify-center px-4 sm:px-6 py-2 rounded-xl bg-primary-container text-on-primary-container font-bold shadow-lg hover:brightness-110 transition-all active:scale-95">
                انضم كشريك
              </JoinPartnerLink>
            </>
          ) : (
            <div className="flex min-w-0 flex-1 items-center max-md:justify-start max-md:[direction:ltr] max-md:gap-2 md:flex-initial md:justify-start md:gap-4">
              ...
              <div className="flex min-w-0 items-center gap-2 sm:gap-4">
                <JoinPartnerLink className="md:hidden inline-flex items-center justify-center min-h-10 shrink-0 px-3.5 py-2 rounded-xl bg-primary-container text-on-primary-container text-sm font-bold leading-snug shadow-md hover:brightness-110 transition-all active:scale-[0.98] focus:outline-none focus-visible:ring-2 focus-visible:ring-primary-container/60 focus-visible:ring-offset-2 focus-visible:ring-offset-[#131313] whitespace-nowrap">
                  انضم الآن
                </JoinPartnerLink>
